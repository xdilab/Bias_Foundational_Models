...
def main(args):
    ...
    torch.distributed.init_process_group(backend="gloo", init_method='env://', timeout=datetime.timedelta(seconds=7200))   # might takes a long time to sync between process
